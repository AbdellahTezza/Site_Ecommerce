<template>
    ...
    <div class="container">
    <blog-posts v-for="(blog, index) in blogs" 
        :key="index" 
        :Titlepost="blog.date"
        :imgUrl="blog.img"
        :Subpost="blog.title"
    ...
    data() {
        return {
            blogs: [
                ...
                {
                    date: "13/04",
                    img: require("@/assets/images/blog/b2.webp"),
                ...
                {
                    date: "12/01",
                    img: require("@/assets/images/blog/b3.webp"),
                ...
                {
                    date: "16/01",
                    img: require("@/assets/images/blog/b4.webp"),
                ...
                {
                    date: "06/07",
                    img: require("@/assets/images/blog/b6.webp"),
